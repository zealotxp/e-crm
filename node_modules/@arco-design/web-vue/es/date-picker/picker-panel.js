  ...
  return openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      ...
      _ctx.headerMode ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        ...
        }, null, 8, ["header-value", "header-icons", "header-operations", "disabled-date", "onSelect"])) : _ctx.headerMode === "month" ? (openBlock(), createBlock(_component_MonthPanel, {
          key: 1,
          "header-value": _ctx.headerPanelHeaderValue,
          "header-icons": _ctx.headerIcons,
          "header-operations": _ctx.headerPanelHeaderOperations,
        ...
        }, null, 8, ["header-value", "header-icons", "header-operations", "abbreviation", "disabled-date", "onSelect", "onHeaderLabelClick"])) : createCommentVNode("v-if", true)
