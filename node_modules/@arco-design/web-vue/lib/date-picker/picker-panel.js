...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const hasShortcuts = vue.computed(
      () => Boolean(shortcuts2.value && shortcuts2.value.length)
    );
    const showShortcutsNowBtn = vue.computed(
    ...
    const showShortcutsInLeft = vue.computed(
      () => showShortcuts.value && shortcutsPosition.value === "left"
    );
    const showShortcutsInRight = vue.computed(
      () => showShortcuts.value && shortcutsPosition.value === "right"
    );
    const showShortcutsInBottom = vue.computed(
    ...
    function getShortcutValue(shortcut) {
      ...
      return date.getDayjsValue(
        is.isFunction(value2) ? value2() : value2,
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", {
      ...
      _ctx.headerMode ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
        ...
        }, null, 8, ["header-value", "header-icons", "header-operations", "disabled-date", "onSelect"])) : _ctx.headerMode === "month" ? (vue.openBlock(), vue.createBlock(_component_MonthPanel, {
          key: 1,
          "header-value": _ctx.headerPanelHeaderValue,
          "header-icons": _ctx.headerIcons,
          "header-operations": _ctx.headerPanelHeaderOperations,
        ...
        }, null, 8, ["header-value", "header-icons", "header-operations", "abbreviation", "disabled-date", "onSelect", "onHeaderLabelClick"])) : vue.createCommentVNode("v-if", true)
