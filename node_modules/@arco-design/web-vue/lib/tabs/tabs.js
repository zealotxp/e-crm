...
var context$1 = require("../config-provider/context.js");
var _Tabs = vue.defineComponent({
  ...
  setup(props, {
    ...
    const tabMap = vue.reactive(/* @__PURE__ */ new Map());
    ...
    const configCtx = vue.inject(context$1.configProviderInjectionKey, void 0);
