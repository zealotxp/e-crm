...
var _Table = vue.defineComponent({
  ...
  setup(props, {
    ...
    const slotColumnMap = vue.reactive(/* @__PURE__ */ new Map());
    ...
    const renderContent = () => {
      var _a, _b;
      if (splitTable.value) {
        const top = is.isNumber(props.stickyHeader) ? `${props.stickyHeader}px` : void 0;
        ...
        const Component = displayScrollbar.value ? index$1 : "div";
    ...
    const renderPagination = () => {
      ...
      }, [(_a = slots["pagination-left"]) == null ? void 0 : _a.call(slots), vue.createVNode(index$2, vue.mergeProps({
