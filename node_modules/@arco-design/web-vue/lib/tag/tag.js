...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const isBuiltInColor = vue.computed(
      () => props.color && _interface.TAG_COLORS.includes(props.color)
    );
    const isCustomColor = vue.computed(
      () => props.color && !_interface.TAG_COLORS.includes(props.color)
    );
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.computedVisible ? (vue.openBlock(), vue.createElementBlock("span", {
    ...
    _ctx.nowrap ? (vue.openBlock(), vue.createElementBlock("span", {
      key: 1,
      class: vue.normalizeClass(`${_ctx.prefixCls}-text`)
    }, [
      vue.renderSlot(_ctx.$slots, "default")
    ], 2)) : vue.renderSlot(_ctx.$slots, "default", { key: 2 }),
